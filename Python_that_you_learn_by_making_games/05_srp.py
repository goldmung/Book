...
if cChoice==uChoice:
    ...
    print("여러분은 고른 것은 가위(S), 컴퓨터가 고른 것은 바위(R). 여러분이 졌네요.")
elif uChoice=="S" and cChoice=="P":
    print("여러분은 고른 것은 가위(S), 컴퓨터가 고른 것은 보(P). 여러분이 이겼네요.")
elif uChoice=="P" and cChoice=="S":
    print("여러분은 고른 것은 보(P), 컴퓨터가 고른 것은 가위(S)." "여러분이 졌네요.")
elif uChoice=="P" and cChoice=="R":
    print("여러분은 고른 것은 보(P), 컴퓨터가 고른 것은 바위(R). 여러분이 이겼네요.")
else:
